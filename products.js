...
(function (global) {
  ...
  [
    ['Букет зефіру 20 см', '20см букет.jpg', 'Квіти з зефіру, діаметр 20 см', 120, '', '', ''],
    ['Букет зефіру 25 см', '25см букет.jpg', 'Квіти з зефіру, діаметр 25 см', 150, '', '', ''],
    ['Дитячий букет', 'Дитячий.jpg', 'Зефірні фігурки та квіти, діаметр 16 см', 75, '', '', ''],
    ['Зефірне печиво', 'Зефірне печиво.jpg', 'Зефіросендвічі з квітами з зефіру', 20, '/шт', '', 'Мінімальне замовлення 5 шт'],
    ['Сумочка з зефіром дитяча', 'Коробочка.jpg', 'Зефір у подарунковій сумочці, розмір 13х13 см', 60, '', '', ''],
    ['Коробочка зефіру 12х15 см', 'Коробочка 1.jpg', 'Зефір у коробочці, розмір 12х15 см', 70, '', '', ''],
    ['Коробочка зефіру 16 см', 'Коробочка 2.jpg', 'Зефір у коробочці, діаметр 16 см', 80, '', '', ''],
    ['Коробочка «Дитяча» тематична', 'Коробочка 3.jpg', 'Тематичне оформлення, наповнення залежить від діаметра', 100, '', '100–150 zł', 'Ціна залежить від діаметра'],
    ['Квіти на коробці', 'Коробочка 4.jpg', 'Квіти з зефіру на коробці, діаметр 12 см', 100, '', '', ''],
    ['Коробочка на 8 завитків', 'Коробочка на 8 зефірів (смак на вибір).jpg', '8 завитків зефіру, смак на вибір', 60, '', '', ''],
    ['Коробочка подвійна 16 см', 'Подвійна коробка.jpg', 'Низ — завитки, зверху — квіти з зефіру, діаметр 16 см', 90, '', '', ''],
    ['Коробочка подвійна 18 см', 'Подвійна коробка 2.jpg', 'Низ — завитки, зверху — квіти з зефіру, діаметр 18 см', 110, '', '', ''],
    ['Подвійна коробочка 15х15 см', 'Подвійна коробка 3.jpg', 'Низ — завитки, зверху — квіти з зефіру, розмір 15х15 см', 70, '', '', '']
  ].forEach(function (c, i) {
    P.push({
      id: 'zef' + (i + 1), cat: 'zefir',
      name: c[0], name_pl: '', desc: c[2], desc_pl: '',
  ...
  /* ---------- 5. Кендібар — 4 трайфли, ціни ще немає ---------- */

  [
    ['Трайфл Шпинат полуниця', 'Шпинат полуниця.jpg', 'Шпинатний бісквіт, м’ятний мус, полуничне конфі, крем чіз маскарпоне'],
    ['Трайфл Шпинат малина', 'Шпинат малина.jpg', 'Шпинатний бісквіт, м’ятний мус, малинове конфі, крем чіз маскарпоне'],
    ['Трайфл Червоний оксамит', 'Червоний оксамит.jpg', 'Бісквіт червоний оксамит, вишневе конфі, полуничний ганаш, крем чіз, маскарпоне'],
    ['Трайфл Снікерс', 'Снікерс.jpg', 'Шоколадний бісквіт, солона карамель, арахіс, крем чіз']
  ].forEach(function (c, i) {
    P.push({
  ...
  [
    ...
    ['candybar', 'Кендібар', '1.jpg'],
    ['candybar', 'Кендібар', '3.jpg'],
    ['candybar', 'Кендібар', '7.jpg'],
    ['candybar', 'Кендібар', '8.jpg']
  ].forEach(function (c, i) {
    var n = i + 1;
    P.push({
      id: 'draft' + n, cat: c[0], draft: true,
