...
(function (global) {
  ...
  /* ---------- контакти ----------
     value показуємо тільки у футері (там є місце), решта місць —
     самий підпис зі стрілкою. Порожній href → лінк неактивний і
     приглушений сірим.
  ...
  var CONTACTS = [
    ...
    { id: 'phone',    label: 'Телефон',  label_pl: 'Telefon',
      value: '+48 787 208 935', href: 'tel:+48787208935' }
  ];
